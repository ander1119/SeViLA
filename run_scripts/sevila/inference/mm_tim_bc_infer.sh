...
CUDA_VISIBLE_DEVICES=1,2 PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:50 python -m torch.distributed.run --nproc_per_node=2 evaluate.py \
--cfg-path lavis/projects/sevila/eval/mm_tim_bc_zs.yaml \

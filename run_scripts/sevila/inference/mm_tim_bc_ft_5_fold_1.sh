...
exp_name='mm_tim_ft_fullset_5_fold_1_infer'
# exp_name='test'
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:25 python -m torch.distributed.run --nproc_per_node=8 evaluate.py \
--cfg-path lavis/projects/sevila/eval/mm_tim_bc_zs_split1_1.yaml \
